...
import (
	...
	allocatorv1 "github.com/aojea/clusterip-allocator/api/v1"
	"github.com/aojea/clusterip-allocator/controllers"
...
func init() {
	...
	utilruntime.Must(allocatorv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "839a7206.k8s.io",
	})
	if err != nil {
